...
#Try to format the user input from below list & choice to one dry message
...
if hash.lower() == ANSWER:
        ...
        print ("[*] Your standard strong encryption algorithm output is:", crypt.crypt(hash))
        sys.exit(0)
...
if CRYPT_.lower() == 'yes':
        ...
        print ("[*] Your crypt output is:", crypt.crypt(CRYPT_, "CRYPT"))
        sys.exit(0)
...
if SHA256_.lower() == 'yes':
        ...
        print ("[*] Your sha256 output is:", crypt.crypt(SHA256_, "SHA256"))
        sys.exit(0)
...
if SHA512_.lower() == 'yes':
        ...
        print ("[*] Your sha512 output is:", crypt.crypt(SHA512_, "SHA512"))
        sys.exit(0)
...
if BLOWFISH_.lower() == 'yes':
        ...
        print ("[*] Your blowfish output is:", crypt.crypt(BLOWFISH_, "BLOWFISH"))
        sys.exit(0)
...
if MD5_.lower() == 'yes':
        ...
        print ("[*] Your md5 output is:", crypt.crypt(MD5_, "MD5"))
        sys.exit(0)
...
if HEX_.lower() == 'yes':
	...
	print ("[*] Your hex output is:", crypt.crypt(HEX_, "HX"))
